...
function Particles.initialize()
    ...
    emitters.fire:setParticleLifetime(0.1, 0.3)
    emitters.fire:setDirection(-math.pi/2)
    emitters.fire:setSpread(math.pi/8)
    emitters.fire:setAreaSpread('normal', 1, 1)
    emitters.fire:setSpeed(0, 200)
    emitters.fire:setColors(255, 255, 0, 255, 255, 182, 0, 255, 255, 73, 73, 255, 146, 36, 36, 255, 50, 20, 20, 255, 10, 10, 10, 255)
